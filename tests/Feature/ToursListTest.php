...
class ToursListTest extends TestCase
{
    ...
    public function test_tour_price_is_down_correctly(): void
    {
        $travel = Travel::factory()->create();
        ...
        $response->assertStatus(200);
        $response->assertJsonCount(1, 'data');
        $response->assertJsonFragment(['price' => '150.50']);
    }
    ...
    public function test_tours_list_returns_validation_errors(): void
    {
        ...
        $response = $this->getJson('/api/v1/travels/'.$travel->slug.'/tours?dateFrom=abss');
